...
At the completion of this  project, I learned how importi and to use functions and create
modules in Python. I equally practiced how to use builtin function
`dir()` and using command line arguments in  Python programs.
